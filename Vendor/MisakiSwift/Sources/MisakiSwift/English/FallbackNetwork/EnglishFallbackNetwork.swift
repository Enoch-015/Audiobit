...
final class EnglishFallbackNetwork {
  ...
  private static func loadConfig(british: Bool) -> BARTConfig? {
    ...
    guard let url = Bundle.misakiResources.url(forResource: fileName, withExtension: "json", subdirectory: "Resources"),
  ...
  private static func loadWeights(british: Bool) -> [String: MLXArray]? {
    ...
    guard let url = Bundle.misakiResources.url(forResource: fileName, withExtension: "safetensors", subdirectory: "Resources"),
